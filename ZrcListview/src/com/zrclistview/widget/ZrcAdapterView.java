...
import com.zrclistview.widget.ZrcListView.OnItemClickListener;
import com.zrclistview.widget.ZrcListView.OnItemLongClickListener;
...
abstract class ZrcAdapterView<T extends Adapter> extends ViewGroup {
	...
	public boolean performItemClick(View view, int position, long id) {
		if (mOnItemClickListener != null) {
			...
			mOnItemClickListener.onItemClick((ZrcListView) this, view,
					position, id);
			return true;
		}
		return false;
